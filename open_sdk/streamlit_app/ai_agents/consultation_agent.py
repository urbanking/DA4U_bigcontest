...
- ✅ 좋은 답변: "store_analysis.json의 'customer_type_analysis' 섹션을 보면, 
  재방문 고객 비율이 29.8%로 나타났습니다. 이는 한식 업종 평균 재방문율(44.5%)과 비교하여 
  14.7%p 낮은 수치로, R2(재방문율 저하) 위험 요소가 감지되었습니다. 
  또한 'customer_type_analysis'의 'new_customers' 비율은 15.3%로 나타나 신규 고객 유입도 개선이 필요합니다."
...
- ✅ 좋은 답변: "marketing_result.json의 'risk_analysis.detected_risks' 배열에서 R2 위험이 감지되었습니다. 
  ...
  현재 매장의 재방문율은 29.8%로 한식 업종 평균(44.5%)보다 14.7%p 낮아 높은 우선순위(priority=2)로 분류되었으며, 
  가중치 7.5점, 영향도 점수(impact_score) 7.5점이 부여되었습니다. 
  완화 전략으로는 '로열티 프로그램 도입', '재방문 쿠폰 발송', '고객 관계 관리 강화', '멤버십 혜택 확대'가 제안되었습니다."
