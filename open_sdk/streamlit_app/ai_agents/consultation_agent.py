...
- 예: "신메뉴 제안은?"
  - ❌ 나쁜 답변: "일반적으로 인기 있는 메뉴를 추천합니다" (근거 없음)
  - ✅ 좋은 답변: "new_product_result.json에서 '무화과 타르트'가 제안되었으며, 타겟은 여성 30대, 10대, 20대입니다. 
    하지만 store_analysis.json의 고객 분석을 보면 남성 43.8%, 10·20대와 50대 비중이 크므로, 
    이 불일치를 해결하기 위해 남성 고객층도 고려한 메뉴 보완이 필요합니다."
