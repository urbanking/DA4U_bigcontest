...
def expand_under20(age_groups: Dict[str, float]) -> Dict[str, float]:
    ...
    실제 분포 데이터를 유지하며, "20대 이하"는 "20대"로 매핑
    ...
    Returns:
        확장된 연령 분포 {"10대": 0.0, "20대": 23.2, "30대": 31.1, ...}
    """
    res = {
        "10대": 0.0,
        "20대": 0.0,
    ...
    # 20대 이하는 전부 "20대"에 할당 (실제 데이터 유지)
    # 크롤링 시에는 to_datalab_age_checks()가 "10대"+"20대" 모두 체크
    under20 = float(age_groups.get("20대 이하", 0.0))
    res["20대"] = under20  # 전체 비율을 20대에 할당
